...
**app** | **string** | App name (transcoding) | [default to undefined]

## Example

```typescript
import { SiteBroadcastStatusTranscodingResponse } from 'streamvi-api-client';

const instance: SiteBroadcastStatusTranscodingResponse = {
    broadcast_id,
    stream_id,
    reconnects,
    date_start,
