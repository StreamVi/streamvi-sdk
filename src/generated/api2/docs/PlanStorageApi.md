...
|[**planStorageSetProlongationV1**](#planstoragesetprolongationv1) | **POST** /method/plan_storage/prolongation | Set storage tariff auto prolongation|
...
# **planStorageSetProlongationV1**
> SuccessResponse planStorageSetProlongationV1()
...
const { status, data } = await apiInstance.planStorageSetProlongationV1(
    language,
    projectId,
    enabled,
    v
