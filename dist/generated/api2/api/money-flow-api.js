...
exports.list1LanguageEnum = exports.list1VEnum = exports.MoneyFlowApi = exports.factory = exports.fp = exports.axiosParamCreator = void 0;
...
const axiosParamCreator = function (configuration) {
    return {
         ...
         */
        list1: async (v, language, projectId, limit, offset, dateFrom, dateTo, type, balanceType, options = {}) => {
...
const fp = function (configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async list1(v, language, projectId, limit, offset, dateFrom, dateTo, type, balanceType, options) {
            var _a, _b, _c;
            ...
            const localVarOperationServerBasePath = (_c = (_b = base_1.operationServerMap['MoneyFlowApi.list1']) === null || _b === void 0 ? void 0 : _b[localVarOperationServerIndex]) === null || _c === void 0 ? void 0 : _c.url;
